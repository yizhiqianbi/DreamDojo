...
export const metadata: Metadata = {
  ...
  description:
    'Explore 48-step π0.5 action samples as parallel 49-frame DreamDojo futures from the same recorded Jokeru observation.',
  openGraph: {
    title: 'DreamDojo × π0.5 · Parallel Worlds Lab',
    description:
  ...
  twitter: {
    ...
    title: 'DreamDojo × π0.5 · Parallel Worlds Lab',
    description:
      'Parallel 48-step robot futures sampled with π0.5 and generated by DreamDojo 2B.',
